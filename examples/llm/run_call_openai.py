...
from topicer.llm import OpenAsyncAPI
...
async def call_run(args):
    ...
    api = OpenAsyncAPI.create(SCRIPT_DIR / "openai_config.yaml")
...
async def call_create_config(args):
    ...
    c = Config(OpenAsyncAPI)
    c.save(SCRIPT_DIR / "openai_config.yaml")
    c.to_md(SCRIPT_DIR / "openai_config.md")
